...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ytmusicapi-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15061&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ytmusicapi-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ytmusicapi` can be installed with:

```
conda install ytmusicapi
```

It is possible to list all of the versions of `ytmusicapi` available on your platform with:
